...
echo "========================================================================"
echo "RADAR FAST TRAINING PIPELINE (OPTIMIZED FOR SPEED)"
echo "========================================================================"
echo "This script will:"
echo "  1. Download WildDeepfake dataset (~10GB) [15-30 min]"
echo "  2. Train on 20% subset (~230k images) [1.5-2.5 hours]"
echo "  3. Export results [1-2 min]"
echo ""
echo "Total estimated time: 2-3 hours (vs 13-19 hours for full dataset)"
echo ""
echo "Optimizations:"
echo "  • Dataset: 20% subset (230k images)"
